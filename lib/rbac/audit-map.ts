...
export const AUDIT_ROUTE_MAP: AuditRouteMap = {
  ...
  "app/api/quality/route.ts": ["QUALITY_CHECK_CREATED"],
  "app/api/quality/[id]/route.ts": ["QUALITY_CHECK_UPDATED", "QUALITY_CHECK_DELETED"],
  "app/api/quality/[id]/status/route.ts": ["QUALITY_CHECK_STATUS_CHANGED"],
