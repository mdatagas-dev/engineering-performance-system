...
import { CHANGELOG, t, type Lang } from "@/lib/i18n";
      ...
      <div className="relative">
        ...
        <div className="mt-6">
          ...
          <div className="mt-3 flex flex-col gap-3">
            {CHANGELOG.map((entry) => (
              <div key={entry.version} className="rounded-xl border border-slate-950/10 bg-white/50 p-4 dark:border-white/10 dark:bg-white/5">
                <div className="flex flex-wrap items-center gap-2">
                  <span className="rounded-lg bg-gradient-to-r from-rose-600 to-pink-700 px-2.5 py-1 font-mono text-xs font-bold text-white shadow-lg shadow-rose-600/20">
                    {entry.version}
                  </span>
